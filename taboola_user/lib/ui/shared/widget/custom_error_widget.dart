...
import '/ui/shared/widget/custom_button.dart';
          ...
          children: [
            Column(
              ...
              children: [
                ...
                SizedBox( width: MediaQuery.of(context).size.width*0.9,child: Text(checkIfConnect?widget.textError:  "No internet connection",textAlign: TextAlign.center,overflow: TextOverflow.clip, )),
