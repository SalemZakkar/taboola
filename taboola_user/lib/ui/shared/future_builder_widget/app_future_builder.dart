...
import '/main_sdk/models/common/error_model.dart';
import '/main_sdk/models/common/model.dart';
import '/main_sdk/models/common/result_class.dart';
import '/ui/shared/widget/custom_error_widget.dart';
  ...
  Widget retry(ErrorState? errorState) {
    return Center(
      child: ErrorsWidget(
        ...
        textError: errorState?.errorMessage.error?.message ?? S.of(context).unknown_Error,
      ),
    );
  }
}
