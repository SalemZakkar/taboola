  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SnakeNavigationBar.color(
        ...
        //snakeViewColor: Colors.transparent.withOpacity(0),
        selectedItemColor: AppColors.kPrimaryYellowColor,
        unselectedItemColor: AppColors.kPrimaryBodyColor,
        ...
        onTap: (index) => setState(() {
          selectedPage = index;
          homeController.animateToPage(index,
              duration: Duration(milliseconds: 15), curve: Curves.easeIn);
